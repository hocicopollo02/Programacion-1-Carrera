...
public class PolygonGroup { 
    ...
    public void add(Polygon pol) {
        this.front = new NodePol(pol, this.front);
    ...
    public Polygon[] toArray() {
        Polygon[] result = new Polygon[this.size];
        NodePol aux = this.front;
    ...
    private NodePol[] search(Point p) {
        ...
        NodePol aux = this.front, prevAux = null;
    ...
    public boolean remove(Point p) {
        ...
        if (mark != null) {
            ...
            if(mark == this.front) { this.front = this.front.next; }
            else { prevMark.next = mark.next; }
            if (mark == this.back){ this.back = prevMark; }
            this.size--;
            return true;
        }
        return false;
    ...
    public void toFront(Point p) {
        ...
        if (mark != null) { 
            ...
            if(mark != this.front) {
                ...
                //Sacar el nodo de la secuencia
                prevMark.next = mark.next;
                
                //Situarlo al frente
                mark.next = this.front;
                
                this.front = mark;
                
                if(this.back == mark) { this.back = prevMark; }
